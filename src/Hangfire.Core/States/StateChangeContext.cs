...
using Annotations = Hangfire.Annotations;
...
namespace Hangfire.States
{
    ...
    public class StateChangeContext
    {
        ...
        public StateChangeContext(
            ...
            [NotNull] string backgroundJobId,
            [NotNull] IState newState,
            [Annotations.CanBeNull] params string[] expectedStates)
        ...
        public StateChangeContext(
            ...
            [NotNull] string backgroundJobId,
            [NotNull] IState newState,
            [Annotations.CanBeNull] IEnumerable<string> expectedStates,
        ...
        public StateChangeContext(
            [NotNull] JobStorage storage,
            [NotNull] IStorageConnection connection,
            [Annotations.CanBeNull] JobStorageTransaction transaction,
            [NotNull] string backgroundJobId,
            [NotNull] IState newState,
            [Annotations.CanBeNull] IEnumerable<string> expectedStates,
            CancellationToken cancellationToken)
        ...
        internal StateChangeContext(
            ...
            [Annotations.CanBeNull] string serverId,
            [Annotations.CanBeNull] IReadOnlyDictionary<string, object> customData = null)
        ...
        internal StateChangeContext(
            ...
            [Annotations.CanBeNull] IEnumerable<string> expectedStates,
            bool disableFilters,
            [Annotations.CanBeNull] IFetchedJob completeJob,
            CancellationToken cancellationToken,
            [NotNull] IProfiler profiler,
            [Annotations.CanBeNull] string serverId,
            [Annotations.CanBeNull] IReadOnlyDictionary<string, object> customData = null)
