...
namespace Hangfire.Console.Server
{
    ...
    internal class ConsoleServerFilter : IServerFilter
    {
        ...
        public ConsoleServerFilter(ConsoleOptions options, IPerformContextAccessor performContextAccessor)
        {
            _options = options ?? throw new ArgumentNullException(nameof(options));
            _performContextAccessor = performContextAccessor ?? throw new ArgumentNullException(nameof(performContextAccessor));
        }
        ...
        public void OnPerforming(PerformingContext filterContext)
        {
            ...
            _performContextAccessor.PerformingContext = filterContext;
        }
